...
func initFlags() {
	...
	flag.StringVar(&appKey, "shscap", "FrZfG8UJMATSWui70aMbJ+T3plrGyoFOCRnBbNosfBk=", "secret-handshake app-key or capability; should likely not be changed as this makes you part of a different network")
